...
/**
 * Load fonts, stylesheet, and small mobile menu script.
 */
...
function stb_widgets_init() {
    register_sidebar(
        array(
            'name'          => __( 'Sidebar', 'scenario-three-bistro' ),
            'id'            => 'sidebar-1',
            'description'   => __( 'Add widgets here.', 'scenario-three-bistro' ),
...
/**
 * Add a helpful body class when WooCommerce is active.
 */
...
/**
 * Keep the cart count updated after Ajax add-to-cart.
 */
function stb_customize_cart_fragments( $fragments ) {
    ...
    <a class="header-cart-link" href="<?php echo esc_url( wc_get_cart_url() ); ?>">
        <?php esc_html_e( 'Cart', 'scenario-three-bistro' ); ?>
...
// Remove the default WooCommerce sidebar for a cleaner layout.
remove_action( 'woocommerce_sidebar', 'woocommerce_get_sidebar', 10 );

/**
 * Wrap WooCommerce pages in the same site container.
 */
